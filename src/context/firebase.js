...
export const FirebaseProvider = (props) => {
  ...
  return (
    <FirebaseContext.Provider value={{ signupUserWithEmailAndPassword, loginUserWithEmailAndPassword, signInWithGoogle, handleCreateNewListing, userSignOut, isLoggedIn }}>
      {props.children}
